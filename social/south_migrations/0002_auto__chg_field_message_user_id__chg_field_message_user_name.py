...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.user_id'
        db.alter_column('social_message', 'user_id', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Message.user_name'
        db.alter_column('social_message', 'user_name', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Message.user_id'
        db.alter_column('social_message', 'user_id', self.gf('django.db.models.fields.CharField')(default='', max_length=300))

        # Changing field 'Message.user_name'
        db.alter_column('social_message', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
    ...
    models = {
        'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1368215594'})
        },
        ...
        'social.twittersearch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1368215594'})
        }
    }
