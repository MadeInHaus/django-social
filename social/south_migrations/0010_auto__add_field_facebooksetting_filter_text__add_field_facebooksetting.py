...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookSetting.filter_text'
        db.add_column(u'social_facebooksetting', 'filter_text',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookSetting.filter_link'
        db.add_column(u'social_facebooksetting', 'filter_link',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookSetting.filter_photo'
        db.add_column(u'social_facebooksetting', 'filter_photo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookSetting.filter_video'
        db.add_column(u'social_facebooksetting', 'filter_video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookSetting.filter_text'
        db.delete_column(u'social_facebooksetting', 'filter_text')

        # Deleting field 'FacebookSetting.filter_link'
        db.delete_column(u'social_facebooksetting', 'filter_link')

        # Deleting field 'FacebookSetting.filter_photo'
        db.delete_column(u'social_facebooksetting', 'filter_photo')

        # Deleting field 'FacebookSetting.filter_video'
        db.delete_column(u'social_facebooksetting', 'filter_video')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1379614384'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1379614384'})
        },
