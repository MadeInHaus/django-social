...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramSetting.redirect_uri'
        db.add_column('social_instagramsetting', 'redirect_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramSetting.redirect_uri'
        db.delete_column('social_instagramsetting', 'redirect_uri')
    ...
    models = {
        'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1375824834'})
        },
        ...
        'social.twittersearch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1375824834'})
        },
