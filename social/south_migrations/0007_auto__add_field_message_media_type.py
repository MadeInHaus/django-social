...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.media_type'
        db.add_column(u'social_message', 'media_type',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.media_type'
        db.delete_column(u'social_message', 'media_type')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1379453101'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1379453101'})
        },
