...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookPublicAccount.fb_id'
        db.add_column(u'social_facebookpublicaccount', 'fb_id',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookPublicAccount.last_poll_time'
        db.add_column(u'social_facebookpublicaccount', 'last_poll_time',
                      self.gf('django.db.models.fields.IntegerField')(default=1403027435),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookPublicAccount.fb_id'
        db.delete_column(u'social_facebookpublicaccount', 'fb_id')

        # Deleting field 'FacebookPublicAccount.last_poll_time'
        db.delete_column(u'social_facebookpublicaccount', 'last_poll_time')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1403027435'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1403027435'})
        },
