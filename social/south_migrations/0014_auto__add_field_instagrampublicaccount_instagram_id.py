...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramPublicAccount.instagram_id'
        db.add_column(u'social_instagrampublicaccount', 'instagram_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramPublicAccount.instagram_id'
        db.delete_column(u'social_instagrampublicaccount', 'instagram_id')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1403030276'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1403030276'})
        },
