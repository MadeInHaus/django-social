...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookSearch'
        db.create_table('social_facebooksearch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('search_term', self.gf('django.db.models.fields.CharField')(max_length=160, blank=True)),
        ))
        db.send_create_signal('social', ['FacebookSearch'])


    def backwards(self, orm):
        # Deleting model 'FacebookSearch'
        db.delete_table('social_facebooksearch')
    ...
    models = {
        'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1379521864'})
        },
        ...
        'social.twittersearch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1379521864'})
        },
