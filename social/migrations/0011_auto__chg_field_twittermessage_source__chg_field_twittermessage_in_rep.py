...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TwitterMessage.source'
        db.alter_column(u'social_twittermessage', 'source', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'TwitterMessage.in_reply_to_screen_name'
        db.alter_column(u'social_twittermessage', 'in_reply_to_screen_name', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))
        # Adding index on 'Message', fields ['status']
        db.create_index(u'social_message', ['status'])

        # Adding index on 'Message', fields ['network']
        db.create_index(u'social_message', ['network'])

        # Adding index on 'Message', fields ['date']
        db.create_index(u'social_message', ['date'])

        # Adding index on 'Message', fields ['media_type']
        db.create_index(u'social_message', ['media_type'])


        # Changing field 'Message.message_id'
        db.alter_column(u'social_message', 'message_id', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'TwitterAccount.name'
        db.alter_column(u'social_twitteraccount', 'name', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'TwitterAccount.location'
        db.alter_column(u'social_twitteraccount', 'location', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'TwitterAccount.screen_name'
        db.alter_column(u'social_twitteraccount', 'screen_name', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):
        # Removing index on 'Message', fields ['media_type']
        db.delete_index(u'social_message', ['media_type'])

        # Removing index on 'Message', fields ['date']
        db.delete_index(u'social_message', ['date'])

        # Removing index on 'Message', fields ['network']
        db.delete_index(u'social_message', ['network'])

        # Removing index on 'Message', fields ['status']
        db.delete_index(u'social_message', ['status'])


        # Changing field 'TwitterMessage.source'
        db.alter_column(u'social_twittermessage', 'source', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'TwitterMessage.in_reply_to_screen_name'
        db.alter_column(u'social_twittermessage', 'in_reply_to_screen_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.message_id'
        db.alter_column(u'social_message', 'message_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'TwitterAccount.name'
        db.alter_column(u'social_twitteraccount', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'TwitterAccount.location'
        db.alter_column(u'social_twitteraccount', 'location', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'TwitterAccount.screen_name'
        db.alter_column(u'social_twitteraccount', 'screen_name', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1380324463'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1380324463'})
        },
