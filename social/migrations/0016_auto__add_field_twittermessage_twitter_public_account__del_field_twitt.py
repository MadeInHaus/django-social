...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterMessage.twitter_public_account'
        db.add_column(u'social_twittermessage', 'twitter_public_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.TwitterPublicAccount'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TwitterPublicAccount.username'
        db.delete_column(u'social_twitterpublicaccount', 'username')

        # Adding field 'TwitterPublicAccount.screen_name'
        db.add_column(u'social_twitterpublicaccount', 'screen_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterMessage.twitter_public_account'
        db.delete_column(u'social_twittermessage', 'twitter_public_account_id')


        # User chose to not deal with backwards NULL issues for 'TwitterPublicAccount.username'
        raise RuntimeError("Cannot reverse this migration. 'TwitterPublicAccount.username' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TwitterPublicAccount.username'
        db.add_column(u'social_twitterpublicaccount', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'TwitterPublicAccount.screen_name'
        db.delete_column(u'social_twitterpublicaccount', 'screen_name')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1403037288'})
        },
        ...
        u'social.twittermessage': {
            ...
            'twitter_public_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.TwitterPublicAccount']", 'null': 'True', 'blank': 'True'}),
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1403037288'})
        },
