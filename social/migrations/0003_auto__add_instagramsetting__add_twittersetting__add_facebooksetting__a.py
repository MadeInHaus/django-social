...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstagramSetting'
        db.create_table('social_instagramsetting', (
            ...
            ('interval', self.gf('django.db.models.fields.IntegerField')(default=15)),
            ('auto_approve', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('social', ['InstagramSetting'])

        # Adding model 'TwitterSetting'
        db.create_table('social_twittersetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('social', ['TwitterSetting'])

        # Adding model 'FacebookSetting'
        db.create_table('social_facebooksetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('app_secret', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('interval', self.gf('django.db.models.fields.IntegerField')(default=15)),
            ('auto_approve', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('social', ['FacebookSetting'])

        # Adding model 'RSSSetting'
        db.create_table('social_rsssetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('interval', self.gf('django.db.models.fields.IntegerField')(default=15)),
            ('auto_approve', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('social', ['RSSSetting'])


    def backwards(self, orm):
        # Deleting model 'InstagramSetting'
        db.delete_table('social_instagramsetting')

        # Deleting model 'TwitterSetting'
        db.delete_table('social_twittersetting')

        # Deleting model 'FacebookSetting'
        db.delete_table('social_facebooksetting')

        # Deleting model 'RSSSetting'
        db.delete_table('social_rsssetting')
    ...
    models = {
        'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1374551418'})
        },
        ...
        'social.twittersearch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1374551418'})
        },
