...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstagramPublicAccount'
        db.create_table(u'social_instagrampublicaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'social', ['InstagramPublicAccount'])

        # Adding model 'TwitterPublicAccount'
        db.create_table(u'social_twitterpublicaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'social', ['TwitterPublicAccount'])

        # Adding model 'FacebookPublicAccount'
        db.create_table(u'social_facebookpublicaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'social', ['FacebookPublicAccount'])


    def backwards(self, orm):
        # Deleting model 'InstagramPublicAccount'
        db.delete_table(u'social_instagrampublicaccount')

        # Deleting model 'TwitterPublicAccount'
        db.delete_table(u'social_twitterpublicaccount')

        # Deleting model 'FacebookPublicAccount'
        db.delete_table(u'social_facebookpublicaccount')
    ...
    models = {
        u'social.facebookaccount': {
            ...
            'last_poll_time': ('django.db.models.fields.IntegerField', [], {'default': '1402960593'})
        },
        ...
        u'social.twittersearch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'search_until': ('django.db.models.fields.IntegerField', [], {'default': '1402960593'})
        },
